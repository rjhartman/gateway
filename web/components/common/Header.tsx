...
const Component = styled.header(() => [
  tw`border-offBlack border-opacity-30 fixed top-0 left-0 flex flex-row items-center justify-between w-full gap-4 px-4 py-2 duration-300 ease-in-out border-b shadow-xl`,
])
